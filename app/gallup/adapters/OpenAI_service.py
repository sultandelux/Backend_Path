...
class OpenAIService:
    def professions_list(self, galluptext, top5prof, top3fields, MBTI_str, MIT):
        ...
        text2 = re.sub(r'^.*?\n', '\n', conversation.predict(input=f"Based on my gallup strengths and Multiple Intelligences Test results analyse my top 3 career pathways: {top3fields} and describe what these fields about, minimum length of report should be 600 words, at the beggining it should have small introduction, bold names of the professions"))
        text3 = re.sub(r'^.*?\n', '\n', conversation.predict(input=f"Based on my gallup strengths and Multiple Intelligences Test results analyse my top 5 selected professions {top5prof}, minimum length of report should be 400 words, at the beggining it should have small introduction, bold names of the professions"))
